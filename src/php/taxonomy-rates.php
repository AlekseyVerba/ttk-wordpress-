...
?>
            <?php 
                ...
                // if ("Для благоустроек" == $term_title) {
                //     $title = "Для многоквартирных домов";
                // } 

                // if ("Для юридических лиц" == $term_title) {
                //     $title = "Для бизнеса и организаций";
                // }
                
                $term_rates = get_term_by('name', $term_title, 'rates');
                $cat_slug= "";
                $categoryServices = '';
                ...
                <div class="container">
                            ...
                            if ($categories) {
                                foreach ($categories as $key=>$category) {
                                    ...
                                    if ($_GET['category']) {
                                        ...
                                        if ($key == 0) {
                                            $className = "rate__catalog-link rate__catalog-link--active";
                                            $categoryServices =  $category -> slug;
                                        } else {
                                            $className = "rate__catalog-link";
                                        }
                                    }
                                    ...
                                    if (get_field('url_category_services', $category)) {
                                        ...
                                        ?>
                                            <a href="?category=<?= $url ?>" class="<?= $className ?>"><?= $category->name ?></a>
                                        <?php
                                    }
                                    ?>
                    ...
                    <div class="rate__content" style="display: block">
                        <div class="rate__content-item">
                            <div class="rate__content-items rate__content-items--services" style="display: flex">
                                
                            <?php
                            if ($_GET["category"]) {
                                $categoryServices = $_GET["category"];
                            } 
                        ...
                        'tax_query' => [
                            ...
                            [
                                'taxonomy' => 'services',
                                'field'    => 'slug',
                                'terms'    => $categoryServices,
                            ],
                            [
                                'taxonomy' => 'rates',
                                'field'    => 'slug',
                                'terms'    => $term_rates->slug,
                            ]
                        ]
                    ));
                            ...
                            ?>  
                                ...
                                <div class="rate__content-card">
                                    ...
                                    <div class="rate__content-footer">
                                        <a href="/constructor/?service-id=<?= $post->ID ?>&category=<?= $term_rates->slug ?>" class="rate__content-card-link">Настроить тариф</a>
            ...
            <div class="modal__dialog modal__dialog--request">
                <div class="modal__content" data-content>
                    ...
                    <input type="hidden" name="name_page" value="<?= $titlePage ?>" />
                        ...
                        <div id="capcha7" class="g-recaptcha" data-sitekey="6LcprRkbAAAAAEBQCjQ_te7OhFSjE22sqgGpafGz"></div>
